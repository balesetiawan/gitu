<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="gittt.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="gittt" %>
